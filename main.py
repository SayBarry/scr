...
SESSION_ID = """resplace user session"""
...
def get_urls(text):
    ...
    return [url for url in urls if url.startswith(("http://t.me", "https://t.me"))]
    ...
    if message.from_user and message.from_user.id in owner_ids:
        try:
            ...
            if limit >= max_scrape_limit:
                await message.reply_text("Limit must be less than 6000")
                return
